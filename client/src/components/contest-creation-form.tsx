...
export default function ContestCreationForm({ onSuccess }: ContestCreationFormProps) {
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-white font-semibold">Contest Title</FormLabel>
                    <FormControl>
                      <Input
                        placeholder="Enter contest title..."
                        className="bg-white/20 border-white/30 text-white placeholder-gray-300 focus:ring-2 focus:ring-accent outline-none"
                        {...field}
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        ...
                        className="bg-white/20 border-white/30 text-white placeholder-gray-300 focus:ring-2 focus:ring-accent outline-none resize-none"
                        {...field}
              ...
              <div className="grid grid-cols-2 gap-4">
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        <FormControl>
                          <SelectTrigger className="bg-white/20 border-white/30 text-white focus:ring-2 focus:ring-accent outline-none" data-testid="select-category">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-white font-semibold">Duration (days)</FormLabel>
                      <FormControl>
                        <Input
                          type="number"
                          min="1"
              ...
              <div className="grid grid-cols-2 gap-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-white font-semibold">Entry Fee (ETH)</FormLabel>
                      <FormControl>
                        <Input
                          type="number"
                          step="0.001"
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-white font-semibold">Max Participants</FormLabel>
                      <FormControl>
                        <Input
                          type="number"
                          min="2"
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-white font-semibold">Prize Distribution</FormLabel>
                    <FormControl>
                      <RadioGroup
                      ...
                      >
                        <div className="flex items-center space-x-3">
                          <RadioGroupItem value="winner-takes-all" id="winner-takes-all" className="text-accent focus:ring-accent" />
                          <label htmlFor="winner-takes-all" className="text-white cursor-pointer">
                            Winner Takes All
                          </label>
                        </div>
                        <div className="flex items-center space-x-3">
                          <RadioGroupItem value="top-three" id="top-three" className="text-accent focus:ring-accent" />
                          <label htmlFor="top-three" className="text-white cursor-pointer">
                            Top 3 Split (50% / 30% / 20%)
                          </label>
                        </div>
                        <div className="flex items-center space-x-3">
                          <RadioGroupItem value="sponsor-funded" id="sponsor-funded" className="text-accent focus:ring-accent" />
      ...
      <Card className="bg-white/10 backdrop-blur-sm border-white/20" data-testid="contest-preview">
        ...
        <CardContent className="space-y-6">
          <div className="bg-card-bg text-primary p-6 rounded-lg">
            ...
            <div className="text-center text-sm text-gray-600">
              Entry Fee: <span className="font-semibold text-primary" data-testid="preview-entry-fee">
          ...
          <Button
            ...
            className="w-full bg-gradient-to-r from-accent to-orange-500 text-white font-bold py-4 rounded-lg hover:shadow-lg transition-all duration-200 transform hover:scale-105"
